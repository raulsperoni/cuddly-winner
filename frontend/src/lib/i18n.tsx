...
const translations = {
  en: {
    ...
    aiRevisedDraft: 'Human revision of AI draft',
    aiRevisedBy: ({ name = '' }) => `AI draft revised by ${name}`,
  ...
  es: {
    ...
    aiRevisedDraft: 'Revisión humana de borrador de IA',
    aiRevisedBy: ({ name = '' }) => `Borrador de IA revisado por ${name}`,
